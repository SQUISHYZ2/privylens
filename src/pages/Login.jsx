...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setError(err.code === "auth/popup-closed-by-user" ? null : "Authentication failed. Please try again.");
      setLoading(false);
    }
  };
